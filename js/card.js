...
// boton resetear main ciudades guardadas


// Obtener una referencia al botón de reset
const resetButton = document.getElementById('resetButton');

// Agregar un listener de eventos para el clic en el botón de reset
resetButton.addEventListener('click', () => {
  // Restablecer el valor de "createdCities" en el almacenamiento local
  localStorage.removeItem("createdCities");

  // También puedes restablecer el valor en la variable createdCities
  createdCities = null;

  // También puedes limpiar el contenido de cardContainer
  const cardContainer = document.querySelector('.card-container');
  cardContainer.innerHTML = '';
